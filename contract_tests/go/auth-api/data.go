...
// APIStatus represents a service status message returned by /api/status endpoint.
...
// InvalidToken represents a message returned when the Authorization header is invalid in secured endpoint calls
...
// MissingToken represents a message returned when the Authorization header is missing to secured endpoint calls
