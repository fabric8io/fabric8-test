...
export class WorkItemQuickAdd extends ui.Clickable {
  ...
  addButton = new ui.Button(this.buttonsDiv.$('button.btn.btn-primary'), 'Add Button');
  addAndOpenButton = new ui.Button(this.buttonsDiv.$('button.btn.btn-default'), 'Add and Open Button');
